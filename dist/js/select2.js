...
S2.define('select2/data/matcher',[
    '../utils',
    '../diacritics',
    'jquery'
...
S2.define('select2/data/hintMatcher',[
    '../utils',
    '../diacritics',
    './matcher',
    'jquery'
...
S2.define('select2/defaults',[
    ...
    Defaults.prototype.apply = function (options) {
        ...
        if (options.matcher == null) {
            if (options.hint_matcher != null) {
                options.matcher = new HintMatcher();
            } else {
                options.matcher = new TextMatcher();
            }
        }
